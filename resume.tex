...
\textbf{\href{https://www.ringcentral.com/}{Spearbit Labs}} (remote -  Miami, Florida), 10/2023 - present.

Developing a Frontend architecture for a modern code quality control platform. Hands-on coding experience for a frontend side. Optimized a development process, automated a code quality control, decreased time to release and a number of regression cases.
...
\href{https://vitonsky.net/blog/2024/03/20/decision-logs/}{Decision logs are important}
